...
- `AppModel` owns connection state, server snapshots, navigation selection, project-command configuration, request tasks, foreground refresh, and active-work polling.
